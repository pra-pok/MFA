...
use App\Utils;
class OrganizationGroupController extends DM_BaseController
{
    protected $panel = 'Organization Group';
    protected $base_route = 'organization-group';
    protected $view_path = 'admin.components.organization_group';
    protected $model;
    protected $table;

    public function __construct(Request $request, OrganizationGroup $organization_group)
    {
        $this->model = $organization_group;
    }
    /**
