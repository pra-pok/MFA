    ...
    <div class="mt-4">
        ...
        <div class="modal fade" id="basicModal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog" role="document">
               @include('admin.components.organization_group.create')
            </div>
        </div>
    </div>
    <div class="mt-4">
        ...
        <div class="modal fade" id="edit-basic" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog" role="document">
                @include('admin.components.organization_group.edit')
            </div>
        </div>
    </div>
@endsection
    ...
    <script>
        $('#datatable').DataTable({
            ...
            rowCallback: function (row, data, index) {
                ...
                const deleteUrl = `{{ url('organization-group') }}/${data.id}`;
        ...
        function editCategory(id) {
            $.ajax({
                url: `/organization-group/${id}/edit`,
                type: 'GET',
                success: function(response) {
                    ...
                    $('#editForm').attr('action', `/organization-group/${id}`);
