        ...
        @if (isset($data['organization_courses']) && $data['organization_courses']->count() > 0)
            @foreach ($data['organization_courses'] as $key => $record)
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapse-{{$uniqueId}}" class="accordion-collapse collapse {{ $key == 0 ? 'show' : '' }}"
                         aria-labelledby="heading-{{$uniqueId}}" data-bs-parent="#organizationCoursesAccordion">
            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="heading-new">
                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                            data-bs-target="#collapse-new"
                            aria-expanded="true" aria-controls="collapse-new">
                        Add New Course
                    </button>
                </h2>
                <div id="collapse-new" class="accordion-collapse collapse show" aria-labelledby="heading-new">
                    <div class="accordion-body">
                        <div class="row form-row">
                            <div class="col-md-6 mt-3">
                                <label for="course_id"> Course</label>
