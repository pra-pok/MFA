    ...
    <table id="datatable" class="table table-bordered">
            ...
            <tr>
                ...
                <td>
                    ...
                    @if ($gallery->type == 1 && $gallery->media)
                        <img src="{{ asset('images/organization-gallery/' . $gallery->media) }}" alt="Media" class="img-thumbnail" style="width: 100px; height: 100px; margin-top: 10px;">
        ...
        @empty
            <tr>
                ...
                <td>
                    <button type="button" class="btn btn-primary add-row"><i class="bx bx-plus"></i></button> <br></br>
                    <button type="button" class="btn btn-danger remove-row"><i class="bx bx-trash"></i></button>
                </td>
            </tr>
        @endforelse
